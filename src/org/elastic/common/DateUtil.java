...
public class DateUtil
{
    ...
    private final static FieldPosition                     ms_FieldPosition     = new FieldPosition(
                                                                                        0);
    ...
    static
    {
        ms_Formats.put(ms_RELEASEDATEFORMAT, new SimpleDateFormat(
                ms_RELEASEDATEFORMAT));
        ms_Formats.put(ms_DELETEDATEFORMAT, new SimpleDateFormat(
                ms_DELETEDATEFORMAT));
        ms_Formats.put(ms_MDDATEFORMAT, new SimpleDateFormat(ms_MDDATEFORMAT));
        ms_Formats
                .put(ms_ISODATEFORMAT, new SimpleDateFormat(ms_ISODATEFORMAT));
    }

    public static Date createDate(String aStringDate, String aFormat)
            throws Exception
    {
            ...
            throws Exception
    {
        ...
        return sdF.format(aDate, new StringBuffer(), ms_FieldPosition)
                .toString();
    }
